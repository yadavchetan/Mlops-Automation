        ...
        if filename.endswith('.json'):
            ...
            for ele in pageInfoList_json:
                ...
                if os.path.exists(root+"\\"+file_name):
                    os.path.join(class_namewise_doc_directory_path,bucket_dir,folder_name_dir,dt_name_dir)!=file_name_xml
