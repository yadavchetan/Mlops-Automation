...
input_directory = read_config.get("PreClassification","input_loc")
output_dir = read_config.get("PreClassification","output_loc")
doc_type_list = read_config.get("JiraInfo", "doctype")

#doc_type = read_config.get("JiraInfo","doctype")
...
print('../process/Enable_PreClassification.py ', input_directory,' ', output_dir,' ',doc_type_list)
os.system('python ../process/Enable_PreClassification.py '+ input_directory+' ' + output_dir+' '+doc_type_list)
