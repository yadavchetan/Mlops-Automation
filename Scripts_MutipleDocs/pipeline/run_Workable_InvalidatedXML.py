...
input_directory = read_config.get("InvalidatedXML","invalidatedxml_input_directory")
dump_dir = read_config.get("InvalidatedXML","invalidatedxml_dump_dir")
...
print('../process/Workable_InvalidatedXML.py ', input_directory,' ', dump_dir)
os.system('python ../process/Workable_InvalidatedXML.py'+' '+ input_directory +' '+dump_dir)
